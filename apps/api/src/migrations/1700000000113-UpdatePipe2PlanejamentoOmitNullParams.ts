...
- Para valores de parâmetros do tipo LIKE: forneça apenas o texto a buscar, SEM wildcards (%, *). O backend adiciona os wildcards automaticamente. Exemplo: para "clientes que começam com GAMA", passe valor "GAMA", não "GAMA%"
...
export class UpdatePipe2PlanejamentoOmitNullParams1700000000113 implements MigrationInterface {
