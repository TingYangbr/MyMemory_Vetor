...
// Adiciona regra explícita para verbos de busca/listagem (procuro, busco, encontre, etc.)
// que devem classificar como estruturada/listagem, não cair no tiebreak semântica.
...
export class UpdateClassificacaoVerbosListagem1700000000138 implements MigrationInterface {
