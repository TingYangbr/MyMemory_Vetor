...
export class UpdatePipe2PlanejamentoPrompt1700000000111 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    // Reversão não restaura o texto anterior — edite pelo painel admin se necessário
  }
}
